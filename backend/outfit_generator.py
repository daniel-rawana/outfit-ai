...
def create_sample_wardrobe():
    ...
    # Create 10 t-shirts
    t_shirts = [
        Clothing(image_url=None, main_category="top", sub_category="t-shirt", 
    ...
    dress_shirts = [
        Clothing(image_url=None, main_category="top", sub_category="button-up shirt", 
    ...
    # Create 10 pants
    pants = [
        Clothing(image_url=None, main_category="bottom", sub_category="jeans", 
                style="casual", silhouette="regular", color="blue", pattern="solid", 
        ...
        Clothing(image_url=None, main_category="bottom", sub_category="chinos", 
        ...
        Clothing(image_url=None, main_category="bottom", sub_category="slacks", 
    ...
    # Create 10 shorts
    shorts = [
        Clothing(image_url=None, main_category="bottom", sub_category="shorts", 
        ...
        Clothing(image_url=None, main_category="bottom", sub_category="athletic shorts", 
    ...
    # Create 10 shoes
    shoes = [
        Clothing(image_url=None, main_category="footwear", sub_category="dress shoes", 
        ...
        Clothing(image_url=None, main_category="footwear", sub_category="sneakers", 
                style="casual", silhouette="regular", color="white", pattern="solid", 
                season="all", occasion="casual", id=43),
        Clothing(image_url=None, main_category="footwear", sub_category="sneakers", 
                style="casual", silhouette="regular", color="black", pattern="solid", 
                season="all", occasion="casual", id=44),
        Clothing(image_url=None, main_category="footwear", sub_category="running shoes", 
                style="athletic", silhouette="athletic", color="blue", pattern="solid", 
                season="all", occasion="athletic", id=45),
        Clothing(image_url=None, main_category="footwear", sub_category="loafers", 
                style="business", silhouette="slim", color="brown", pattern="solid", 
                season="spring", occasion="work", id=46),
        Clothing(image_url=None, main_category="footwear", sub_category="boots", 
        ...
        Clothing(image_url=None, main_category="footwear", sub_category="sandals", 
                style="casual", silhouette="open", color="brown", pattern="solid", 
                season="summer", occasion="casual", id=49),
        Clothing(image_url=None, main_category="footwear", sub_category="boat shoes", 
